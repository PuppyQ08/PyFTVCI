...
def VCImatrix(w_omega,linrComb,Evlst,nmode,maxorder,FCQ3,FCQ4,Vref,Lambd):
    leng = len(linrComb)
        ...
        for j in range(i,leng):
            ...
            for modeidx in range(nmode):
                ...
                if (diff!=0):
                    multply *=0
                    break
            sumofoperator += Lambd*multply*Vref
            #operator sum FiQi
...
VCImtrx = VCImatrix(w_omega,linrComb,Evlst,nmode,maxorder,FCQ3,FCQ4,Vref,Lambd)
