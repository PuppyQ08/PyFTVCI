...
class VCIthermo:
    def __init__(self,Lambd,Temprt,maxn,calVCI):#calVCI= 1 or filename
        ...
        print("sum of FBBE")
        print(np.sum(w_omega)/2+3*np.sum(w_omega)/2)
        ...
        #w = Energylist
        #v = Coefficient
        #print("Loooooooooooooooooooooooooooooooook",maxn)
        #print(w[0:5]*HatreeTocm)
        ##print(v[:,2])
        ##testl = v[:,0]
        ##for idxx in range(len(testl)):
        ##    if(testl[idxx]>0.1):
        ##        print("id xis ",idxx)
        ##        print("value ", testl[idxx])
        #print((w[1] -w[0])*219474.63)
        #print((w[2] -w[0])*219474.63)
        #print((w[3] -w[0])*219474.63)
        #print((w[4] -w[0])*219474.63)
        #print((w[5] -w[0])*219474.63)
        #print((w[6] -w[0])*219474.63)
        ##print((w[14] -w[7])*219474.63)
        ##print((w[15] -w[7])*219474.63)
        ##print((w[16] -w[7])*219474.63)
        ##print((w[17] -w[7])*219474.63)
        #print("Loooooooooooooooooooooooooooooooook")
